...
uv run pytest      # 667 passed, 2 skipped (tigramite, lightgbm: bring-your-own-env)
```
...
Early (`v0.4.0`), single-author, research code (669 collected tests; Python 3.11–3.14, astral `ruff` + `ty`).

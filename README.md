...
uv run pytest      # 653 passed, 2 skipped (tigramite, lightgbm: bring-your-own-env)
```
...
Early (`v0.4.0`), single-author, research code (655 collected tests; Python 3.11–3.14, astral `ruff` + `ty`).
